    ...
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="<?= base_url() ?>" class="text-decoration-none d-flex align-items-center">
                <img src="<?= base_url('../assets/img/logo/logo-kemenag.png') ?>" width="110" height="42" alt="Presensi Internal Kemenag Kab. Bekasi (PIKSI)" class="navbar-brand-image">
                <span class="ms-2">PIKSI</span>
            </a>
        </h1>
